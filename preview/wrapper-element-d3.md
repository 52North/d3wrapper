...
An example implementation can be found [here](TODO).
...
To see further adaptions like Inputs or Outputs with Eventlisteners look [here](TODO). You will find an example implementation.